  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        setImages({
          img1:
            data.product[0].image1 ||
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEu5mn0Q0Waa49vsVwm3liZ7PrjGUZAI9XcQ&usqp=CAU",
          img2:
            data.product[0].image2 ||
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEu5mn0Q0Waa49vsVwm3liZ7PrjGUZAI9XcQ&usqp=CAU",
          img3:
            data.product[0].image3 ||
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEu5mn0Q0Waa49vsVwm3liZ7PrjGUZAI9XcQ&usqp=CAU",
          img4:
            data.product[0].image4 ||
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEu5mn0Q0Waa49vsVwm3liZ7PrjGUZAI9XcQ&usqp=CAU",
          img5:
            data.product[0].image5 ||
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEu5mn0Q0Waa49vsVwm3liZ7PrjGUZAI9XcQ&usqp=CAU",
        });
      } catch (err) {
      ...
      <div className="flex flex-col gap-6 lg:w-2/4">
        ...
        <div className="flex flex-row justify-between h-24 lg-w-full w-full overflow-x-auto overflow-y-hidden gap-3">
          <img
            src={images.img1}
            alt=""
            className="w-24 h-24 rounded-md cursor-pointer object-contain shadow-sm"
          ...
          <img
            src={images.img5}
            alt=""
            className="w-24 h-24 rounded-md cursor-pointer text object-contain shadow-sm"
